...
case class AbcList @com.fasterxml.jackson.annotation.JsonIgnore() (
	   ...
	   bytes: Array[Byte],
	   bb: List[Array[Byte]],
	   d: Option[org.joda.time.LocalDate],
	   dd: List[org.joda.time.LocalDate],
	   ...
	   tt: Option[List[Option[org.joda.time.DateTime]]]
