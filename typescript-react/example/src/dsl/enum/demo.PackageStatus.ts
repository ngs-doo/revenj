...
export namespace PackageStatus {
  ...
  export const serialize = Marshaller.Assert.assertEnum<PackageStatus>(PackageStatus.values(), 'PackageStatus');
  export const deserialize = Marshaller.Assert.assertEnum<PackageStatus>(PackageStatus.values(), 'PackageStatus');
}
