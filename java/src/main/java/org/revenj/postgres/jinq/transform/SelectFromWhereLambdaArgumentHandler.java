...
public class SelectFromWhereLambdaArgumentHandler extends LambdaParameterArgumentHandler
{
   ...
   public static SelectFromWhereLambdaArgumentHandler fromSelectFromWhere(SelectFromWhere<?> sfw, LambdaAnalysis lambda, MetamodelUtil metamodel, org.revenj.postgres.jinq.transform.SymbExArgumentHandler parentArgumentScope, boolean hasInQueryStreamSource)
   {
      return new SelectFromWhereLambdaArgumentHandler(sfw.cols, lambda, metamodel, parentArgumentScope, hasInQueryStreamSource);
   }

   public static SelectFromWhereLambdaArgumentHandler fromSelectOnly(SelectOnly<?> select, LambdaAnalysis lambda, MetamodelUtil metamodel, org.revenj.postgres.jinq.transform.SymbExArgumentHandler parentArgumentScope, boolean hasInQueryStreamSource)
   {
      return new SelectFromWhereLambdaArgumentHandler(select.cols, lambda, metamodel, parentArgumentScope, hasInQueryStreamSource);
   }

   public static SelectFromWhereLambdaArgumentHandler forPassthroughTest(LambdaAnalysis lambda, MetamodelUtil metamodel, org.revenj.postgres.jinq.transform.SymbExArgumentHandler parentArgumentScope, boolean hasInQueryStreamSource)
   {
   ...
   private SelectFromWhereLambdaArgumentHandler(ColumnExpressions<?> cols, LambdaAnalysis lambda, MetamodelUtil metamodel, org.revenj.postgres.jinq.transform.SymbExArgumentHandler parentArgumentScope, boolean hasInQueryStreamSource)
   {
