        ...
        try {
            if (query.isSelectFromWhere()) {
                ...
                for (int n = 0; n < lambdas.length; n++) {
                    ...
                    SymbExToColumns translator = config.newSymbExToColumns(new org.revenj.postgres.jinq.transform.AggregateStreamLambdaArgumentHandler(streamTee, lambdas[n], config.metamodel, parentArgumentScope, false));
