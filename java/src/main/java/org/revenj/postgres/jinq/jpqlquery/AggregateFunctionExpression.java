...
public class AggregateFunctionExpression extends Expression {
    final org.revenj.postgres.jinq.jpqlquery.Expression base;
    final String aggregateName;
    final boolean isDistinct;

    public AggregateFunctionExpression(org.revenj.postgres.jinq.jpqlquery.Expression base, String aggregateName, boolean isDistinct) {
        this.base = base;
