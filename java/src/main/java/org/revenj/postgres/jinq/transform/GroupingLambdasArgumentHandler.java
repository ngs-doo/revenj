...
public class GroupingLambdasArgumentHandler extends LambdaParameterArgumentHandler {
    ...
    public GroupingLambdasArgumentHandler(SelectOnly<?> groupKey, SelectOnly<?> stream, LambdaAnalysis lambda, MetamodelUtil metamodel, org.revenj.postgres.jinq.transform.SymbExArgumentHandler parentArgumentScope, boolean hasInQueryStreamSource) {
