...
public class DocumentRepository   implements java.io.Closeable, org.revenj.patterns.Repository<gen.model.binaries.Document>, org.revenj.postgres.BulkRepository<gen.model.binaries.Document>, org.revenj.patterns.PersistableRepository<gen.model.binaries.Document> {
	...
	public DocumentRepository(
			 ...
			 final gen.model.binaries.converters.DocumentConverter converter,
	...
	private final gen.model.binaries.converters.DocumentConverter converter;
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.binaries.Document>> search(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.Document> specification, Integer limit, Integer offset) {
		...
		if (specification == null) {
			sb.append("SELECT array_agg(_r) FROM (SELECT _r FROM \"binaries\".\"Document_entity\" _r");
		}
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				java.util.List<gen.model.binaries.Document> result = org.revenj.postgres.converters.ArrayTuple.parse(rdr, 0, converter::from); 
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Long> count(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.Document> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("SELECT count(*) FROM \"binaries\".\"Document_entity\" r");
		}
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Boolean> exists(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.Document> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("exists(SELECT * FROM \"binaries\".\"Document_entity\" r");
		}
	...
	@Override
	public java.util.Optional<gen.model.binaries.Document> find(String uri) {
	...
	public java.util.List<gen.model.binaries.Document> find(java.util.UUID[] ids, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"binaries\".\"Document_entity\" _r WHERE _r.\"ID\" = ANY(?)");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			...
			java.util.List<gen.model.binaries.Document> result = new java.util.ArrayList<>(ids.length);
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				while (rs.next()) {
					reader.process(rs.getString(1));
					result.add(converter.from(reader));
	...
	public java.util.Optional<gen.model.binaries.Document> find(java.util.UUID id, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"binaries\".\"Document_entity\" _r WHERE _r.\"ID\" = ?");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			statement.setObject(1, id);
			gen.model.binaries.Document instance;
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				if (rs.next()) {
					reader.process(rs.getString(1));
			...
			java.util.List<gen.model.binaries.Document> result = new java.util.ArrayList<>(1);
			result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.Optional<gen.model.binaries.Document>> find(org.revenj.postgres.BulkReaderQuery query, String uri) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		StringBuilder sb = query.getBuilder();
		int index = query.getArgumentIndex();
		if (uri == null) {
		...
		sb.append("SELECT _r FROM \"binaries\".\"Document_entity\" _r WHERE _r.\"ID\" = ?");
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				gen.model.binaries.Document instance = converter.from(rdr);
				if (!hasCustomSecurity) return java.util.Optional.of(instance);
				java.util.List<gen.model.binaries.Document> result = new java.util.ArrayList<>(1);
				result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.binaries.Document>> find(org.revenj.postgres.BulkReaderQuery query, String[] uris) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		...
		sb.append("SELECT array_agg(_r) FROM \"binaries\".\"Document_entity\" _r WHERE _r.\"ID\" = ANY(?)");
		final java.util.UUID[] ids = new java.util.UUID[uris.length];
		for (int i = 0; i < uris.length; i++) {
			try {
				ids[i] = java.util.UUID.fromString(uris[i]);
