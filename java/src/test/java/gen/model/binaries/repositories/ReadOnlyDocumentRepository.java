...
public class ReadOnlyDocumentRepository   implements java.io.Closeable, org.revenj.patterns.SearchableRepository<gen.model.binaries.ReadOnlyDocument> {
	...
	public ReadOnlyDocumentRepository(
			 ...
			 final gen.model.binaries.converters.ReadOnlyDocumentConverter converter,
	...
	private final gen.model.binaries.converters.ReadOnlyDocumentConverter converter;
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.binaries.ReadOnlyDocument>> search(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.ReadOnlyDocument> specification, Integer limit, Integer offset) {
		...
		if (specification == null) {
			sb.append("SELECT array_agg(_r) FROM (SELECT _r FROM (SELECT \"ID\", name from binaries.\"Document\") _r");
		}
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				java.util.List<gen.model.binaries.ReadOnlyDocument> result = org.revenj.postgres.converters.ArrayTuple.parse(rdr, 0, converter::from); 
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Long> count(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.ReadOnlyDocument> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("SELECT count(*) FROM (SELECT \"ID\", name from binaries.\"Document\") r");
		}
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Boolean> exists(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.binaries.ReadOnlyDocument> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("exists(SELECT * FROM (SELECT \"ID\", name from binaries.\"Document\") r");
		}
