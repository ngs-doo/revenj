...
public static class FilterMax   implements java.io.Serializable, org.revenj.patterns.Specification<gen.model.test.CompositeList>, com.dslplatform.json.JsonObject {
	...
	private static final long serialVersionUID = 82152924834831056L;
	...
	public FilterMax setValue(final java.time.LocalDate value) {
		...
		public org.revenj.patterns.Specification<gen.model.test.CompositeList> rewriteLambda() {
			java.time.LocalDate _value_ = this.getValue();
			return it -> it.getChange().compareTo(_value_) >= 0;
		}
