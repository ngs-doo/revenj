...
public class LazyLoadRepository   implements java.io.Closeable, org.revenj.patterns.Repository<gen.model.test.LazyLoad>, org.revenj.postgres.BulkRepository<gen.model.test.LazyLoad>, org.revenj.patterns.PersistableRepository<gen.model.test.LazyLoad> {
	...
	public LazyLoadRepository(
			 ...
			 final gen.model.test.converters.LazyLoadConverter converter,
	...
	private final gen.model.test.converters.LazyLoadConverter converter;
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.test.LazyLoad>> search(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.test.LazyLoad> specification, Integer limit, Integer offset) {
		...
		if (specification == null) {
			sb.append("SELECT array_agg(_r) FROM (SELECT _r FROM \"test\".\"LazyLoad_entity\" _r");
		}
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				java.util.List<gen.model.test.LazyLoad> result = org.revenj.postgres.converters.ArrayTuple.parse(rdr, 0, converter::from); 
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Long> count(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.test.LazyLoad> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("SELECT count(*) FROM \"test\".\"LazyLoad_entity\" r");
		}
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Boolean> exists(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.test.LazyLoad> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("exists(SELECT * FROM \"test\".\"LazyLoad_entity\" r");
		}
	...
	@Override
	public java.util.Optional<gen.model.test.LazyLoad> find(String uri) {
		final int id;
		try {
	...
	public java.util.List<gen.model.test.LazyLoad> find(int[] ids, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"test\".\"LazyLoad_entity\" _r WHERE _r.\"ID\" = ANY(?)");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			...
			java.util.List<gen.model.test.LazyLoad> result = new java.util.ArrayList<>(ids.length);
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				while (rs.next()) {
					reader.process(rs.getString(1));
					result.add(converter.from(reader));
	...
	public java.util.Optional<gen.model.test.LazyLoad> find(int id, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"test\".\"LazyLoad_entity\" _r WHERE _r.\"ID\" = ?");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			statement.setInt(1, id);
			gen.model.test.LazyLoad instance;
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				if (rs.next()) {
					reader.process(rs.getString(1));
			...
			java.util.List<gen.model.test.LazyLoad> result = new java.util.ArrayList<>(1);
			result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.Optional<gen.model.test.LazyLoad>> find(org.revenj.postgres.BulkReaderQuery query, String uri) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		StringBuilder sb = query.getBuilder();
		int index = query.getArgumentIndex();
		if (uri == null) {
		...
		sb.append("SELECT _r FROM \"test\".\"LazyLoad_entity\" _r WHERE _r.\"ID\" = ?");
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				gen.model.test.LazyLoad instance = converter.from(rdr);
				if (!hasCustomSecurity) return java.util.Optional.of(instance);
				java.util.List<gen.model.test.LazyLoad> result = new java.util.ArrayList<>(1);
				result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.test.LazyLoad>> find(org.revenj.postgres.BulkReaderQuery query, String[] uris) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		...
		sb.append("SELECT array_agg(_r) FROM \"test\".\"LazyLoad_entity\" _r WHERE _r.\"ID\" = ANY(?)");
		final int[] ids = new int[uris.length];
		for (int i = 0; i < uris.length; i++) {
			try {
				ids[i] = Integer.parseInt(uris[i]);
