...
public class LazyLoadRepository   implements org.revenj.patterns.Repository<gen.model.test.LazyLoad>, org.revenj.patterns.PersistableRepository<gen.model.test.LazyLoad> {
	...
	public LazyLoadRepository(org.revenj.patterns.ServiceLocator locator) {
		this(locator.resolve(java.sql.Connection.class), new org.revenj.patterns.Generic<org.revenj.postgres.ObjectConverter<gen.model.test.LazyLoad>>(){}.resolve(locator), locator);
	}
	
	//@Override
	private java.util.stream.Stream<gen.model.test.LazyLoad> stream(java.util.Optional<org.revenj.patterns.Specification<gen.model.test.LazyLoad>> filter) {
	...
	public java.util.List<gen.model.test.LazyLoad> search(java.util.Optional<org.revenj.patterns.Specification<gen.model.test.LazyLoad>> filter, java.util.Optional<Integer> limit, java.util.Optional<Integer> offset) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			...
			java.util.stream.Stream<gen.model.test.LazyLoad> stream = stream(filter);
			if (offset != null && offset.orElse(null) != null) {
	...
	public java.util.List<String> persist(
			java.util.List<gen.model.test.LazyLoad> insert,
			java.util.List<java.util.Map.Entry<gen.model.test.LazyLoad, gen.model.test.LazyLoad>> update,
			java.util.List<gen.model.test.LazyLoad> delete) throws java.sql.SQLException {
	...
	public static void __setupSequenceID(java.util.function.BiConsumer<java.util.List<gen.model.test.LazyLoad>, java.sql.Connection> sequence) {
		assignSequenceID = sequence;
	}

	private static java.util.function.BiConsumer<java.util.List<gen.model.test.LazyLoad>, java.sql.Connection> assignSequenceID;
}
