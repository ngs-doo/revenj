...
public class TimestampPkRepository   implements java.io.Closeable, org.revenj.patterns.SearchableRepository<gen.model.issues.TimestampPk>, org.revenj.postgres.BulkRepository<gen.model.issues.TimestampPk>, org.revenj.patterns.PersistableRepository<gen.model.issues.TimestampPk> {
	...
	public TimestampPkRepository(org.revenj.patterns.ServiceLocator locator) {
	...
	public static org.revenj.patterns.Specification<gen.model.issues.TimestampPk> rewriteSpecificationToLambda(org.revenj.patterns.Specification<gen.model.issues.TimestampPk> filter) {
	...
	public org.revenj.patterns.Query<gen.model.issues.TimestampPk> query(org.revenj.patterns.Specification<gen.model.issues.TimestampPk> filter) {
		org.revenj.patterns.Query<gen.model.issues.TimestampPk> query = queryProvider.query(transactionConnection, locator, gen.model.issues.TimestampPk.class);
		if (filter != null) {
	...
	private java.util.List<gen.model.issues.TimestampPk> readFromDb(java.sql.PreparedStatement statement, java.util.List<gen.model.issues.TimestampPk> result) throws java.sql.SQLException, java.io.IOException {
	...
	@Override
	public java.util.List<gen.model.issues.TimestampPk> search(org.revenj.patterns.Specification<gen.model.issues.TimestampPk> specification, Integer limit, Integer offset) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			...
			if (specification == null) {
				sql = "SELECT r FROM \"issues\".\"TimestampPk_entity\" r";
			} 
			else {
				org.revenj.patterns.Query<gen.model.issues.TimestampPk> query = query(specification);
				if (offset != null) {
	...
	public long count(org.revenj.patterns.Specification<gen.model.issues.TimestampPk> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql;
			if (specification == null) {
				sql = "SELECT COUNT(*) FROM \"issues\".\"TimestampPk_entity\" r";
			} 
			else {
				try {
	...
	@Override
	public boolean exists(org.revenj.patterns.Specification<gen.model.issues.TimestampPk> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql = null;
			if (specification == null) {
				sql = "SELECT exists(SELECT * FROM \"issues\".\"TimestampPk_entity\" r";
			} 
			else {
				try {
	...
	@Override
	public java.util.List<gen.model.issues.TimestampPk> find(String[] uris) {
		java.sql.Connection connection = getConnection();
		try (java.sql.Statement statement = connection.createStatement();
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			java.util.List<gen.model.issues.TimestampPk> result = new java.util.ArrayList<>(uris.length);
	...
	public String[] persist(
			java.util.Collection<gen.model.issues.TimestampPk> insert,
			java.util.Collection<java.util.Map.Entry<gen.model.issues.TimestampPk, gen.model.issues.TimestampPk>> update,
			java.util.Collection<gen.model.issues.TimestampPk> delete) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"issues\".\"persist_TimestampPk\"(?, ?, ?, ?)");
			...
			if (insert != null && !insert.isEmpty()) {
				...
				pgo.setType("\"issues\".\"TimestampPk_entity\"[]");
				sw.reset();
				...
				int i = 0;
				for (gen.model.issues.TimestampPk it : insert) {
					result[i++] = it.getURI();
			...
			if (update != null && !update.isEmpty()) {
				java.util.List<gen.model.issues.TimestampPk> oldUpdate = new java.util.ArrayList<>(update.size());
				java.util.List<gen.model.issues.TimestampPk> newUpdate = new java.util.ArrayList<>(update.size());
				java.util.Map<String, Integer> missing = new java.util.HashMap<>();
				int cnt = 0;
				for (java.util.Map.Entry<gen.model.issues.TimestampPk, gen.model.issues.TimestampPk> it : update) {
					gen.model.issues.TimestampPk oldValue = trackChanges.apply(it.getValue());
					if (it.getKey() != null) {
						oldValue = it.getKey();
					}
				...
				if (!missing.isEmpty()) {
					java.util.List<gen.model.issues.TimestampPk> found = find(missing.keySet().toArray(new String[missing.size()]));
					for (gen.model.issues.TimestampPk it : found) {
				...
				pgOld.setType("\"issues\".\"TimestampPk_entity\"[]");
				pgNew.setType("\"issues\".\"TimestampPk_entity\"[]");
	...
	@Override
	public String insert(gen.model.issues.TimestampPk item) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
	...
	@Override
	public void update(gen.model.issues.TimestampPk oldItem, gen.model.issues.TimestampPk newItem) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"issues\".\"update_TimestampPk\"(ARRAY[?], ARRAY[?])");
			 org.revenj.postgres.PostgresWriter sw = org.revenj.postgres.PostgresWriter.create()) {
