...
public class RealmRepository   implements java.io.Closeable, org.revenj.patterns.Repository<gen.model.calc.Realm>, org.revenj.postgres.BulkRepository<gen.model.calc.Realm>, org.revenj.patterns.PersistableRepository<gen.model.calc.Realm> {
	...
	public RealmRepository(org.revenj.patterns.ServiceLocator locator) {
		this(locator.tryResolve(java.sql.Connection.class), locator.resolve(javax.sql.DataSource.class), locator.resolve(org.revenj.postgres.QueryProvider.class), locator.resolve(gen.model.calc.converters.RealmConverter.class), locator);
	}
	

	public static org.revenj.patterns.Specification<gen.model.calc.Realm> rewriteSpecificationToLambda(org.revenj.patterns.Specification<gen.model.calc.Realm> filter) {
	...
	public org.revenj.patterns.Query<gen.model.calc.Realm> query(org.revenj.patterns.Specification<gen.model.calc.Realm> filter) {
		org.revenj.patterns.Query<gen.model.calc.Realm> query = queryProvider.query(transactionConnection, locator, gen.model.calc.Realm.class);
		if (filter != null) {
	...
	private java.util.List<gen.model.calc.Realm> readFromDb(java.sql.PreparedStatement statement, java.util.List<gen.model.calc.Realm> result) throws java.sql.SQLException, java.io.IOException {
	...
	@Override
	public java.util.List<gen.model.calc.Realm> search(org.revenj.patterns.Specification<gen.model.calc.Realm> specification, Integer limit, Integer offset) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			...
			if (specification == null) {
				sql = "SELECT r FROM \"calc\".\"Realm_entity\" r";
			} 
			else {
				org.revenj.patterns.Query<gen.model.calc.Realm> query = query(specification);
				if (offset != null) {
	...
	public long count(org.revenj.patterns.Specification<gen.model.calc.Realm> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql;
			if (specification == null) {
				sql = "SELECT COUNT(*) FROM \"calc\".\"Realm_entity\" r";
			} 
			else {
				try {
	...
	@Override
	public boolean exists(org.revenj.patterns.Specification<gen.model.calc.Realm> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql = null;
			if (specification == null) {
				sql = "SELECT exists(SELECT * FROM \"calc\".\"Realm_entity\" r";
			} 
			else {
				try {
	...
	@Override
	public java.util.List<gen.model.calc.Realm> find(String[] uris) {
		java.sql.Connection connection = getConnection();
		try (java.sql.Statement statement = connection.createStatement();
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			java.util.List<gen.model.calc.Realm> result = new java.util.ArrayList<>(uris.length);
	...
	public String[] persist(
			java.util.Collection<gen.model.calc.Realm> insert,
			java.util.Collection<java.util.Map.Entry<gen.model.calc.Realm, gen.model.calc.Realm>> update,
			java.util.Collection<gen.model.calc.Realm> delete) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"calc\".\"persist_Realm\"(?, ?, ?, ?)");
			...
			if (insert != null && !insert.isEmpty()) {
				...
				int i = 0;
				for (gen.model.calc.Realm it : insert) {
					result[i++] = it.getURI();
			...
			if (update != null && !update.isEmpty()) {
				java.util.List<gen.model.calc.Realm> oldUpdate = new java.util.ArrayList<>(update.size());
				java.util.List<gen.model.calc.Realm> newUpdate = new java.util.ArrayList<>(update.size());
				java.util.Map<String, Integer> missing = new java.util.HashMap<>();
				int cnt = 0;
				for (java.util.Map.Entry<gen.model.calc.Realm, gen.model.calc.Realm> it : update) {
					gen.model.calc.Realm oldValue = trackChanges.apply(it.getValue());
					if (it.getKey() != null) {
						oldValue = it.getKey();
					}
				...
				if (!missing.isEmpty()) {
					java.util.List<gen.model.calc.Realm> found = find(missing.keySet().toArray(new String[missing.size()]));
					for (gen.model.calc.Realm it : found) {
				...
				pgOld.setType("\"calc\".\"Realm_entity\"[]");
				pgNew.setType("\"calc\".\"Realm_entity\"[]");
	...
	@Override
	public String insert(gen.model.calc.Realm item) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
	...
	@Override
	public void update(gen.model.calc.Realm oldItem, gen.model.calc.Realm newItem) throws java.io.IOException {
		java.sql.Connection connection = getConnection();
		try (java.sql.PreparedStatement statement = connection.prepareStatement("/*NO LOAD BALANCE*/SELECT \"calc\".\"update_Realm\"(ARRAY[?], ARRAY[?])");
			 org.revenj.postgres.PostgresWriter sw = org.revenj.postgres.PostgresWriter.create()) {
