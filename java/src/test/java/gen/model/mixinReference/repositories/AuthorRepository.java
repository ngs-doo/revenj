...
public class AuthorRepository   implements java.io.Closeable, org.revenj.patterns.Repository<gen.model.mixinReference.Author>, org.revenj.postgres.BulkRepository<gen.model.mixinReference.Author>, org.revenj.patterns.PersistableRepository<gen.model.mixinReference.Author> {
	...
	public AuthorRepository(
			 ...
			 final gen.model.mixinReference.converters.AuthorConverter converter,
	...
	private final gen.model.mixinReference.converters.AuthorConverter converter;
	...
	private java.util.List<gen.model.mixinReference.Author> readFromDb(java.sql.PreparedStatement statement, java.util.List<gen.model.mixinReference.Author> result) throws java.sql.SQLException, java.io.IOException {
	...
	@Override
	public java.util.List<gen.model.mixinReference.Author> search(org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification, Integer limit, Integer offset) {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.mixinReference.Author>> search(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification, Integer limit, Integer offset) {
		...
		if (specification == null) {
			sb.append("SELECT array_agg(_r) FROM (SELECT _r FROM \"mixinReference\".\"Author_entity\" _r");
		}
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				java.util.List<gen.model.mixinReference.Author> result = org.revenj.postgres.converters.ArrayTuple.parse(rdr, 0, converter::from); 
	...
	@Override
	public long count(org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql;
			if (specification == null) {
				sql = "SELECT COUNT(*) FROM \"mixinReference\".\"Author_entity\" r";
			} 
			else {
				try {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Long> count(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("SELECT count(*) FROM \"mixinReference\".\"Author_entity\" r");
		}
	...
	@Override
	public boolean exists(org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification) {
		...
		try (org.revenj.postgres.PostgresWriter pgWriter = org.revenj.postgres.PostgresWriter.create()) {
			String sql = null;
			if (specification == null) {
				sql = "SELECT exists(SELECT * FROM \"mixinReference\".\"Author_entity\" r";
			} 
			else {
				try {
	...
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, Boolean> exists(org.revenj.postgres.BulkReaderQuery query, org.revenj.patterns.Specification<gen.model.mixinReference.Author> specification) {
		...
		StringBuilder sb = query.getBuilder();
		if (specification == null) {
			sb.append("exists(SELECT * FROM \"mixinReference\".\"Author_entity\" r");
		}
	...
	@Override
	public java.util.Optional<gen.model.mixinReference.Author> find(String uri) {
		final int id;
		try {
	...
	public java.util.List<gen.model.mixinReference.Author> find(int[] ids, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"mixinReference\".\"Author_entity\" _r WHERE _r.\"ID\" = ANY(?)");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			...
			java.util.List<gen.model.mixinReference.Author> result = new java.util.ArrayList<>(ids.length);
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				while (rs.next()) {
					reader.process(rs.getString(1));
					result.add(converter.from(reader));
	...
	public java.util.Optional<gen.model.mixinReference.Author> find(int id, java.sql.Connection connection) {
		try (java.sql.PreparedStatement statement = connection.prepareStatement("SELECT _r FROM \"mixinReference\".\"Author_entity\" _r WHERE _r.\"ID\" = ?");
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			statement.setInt(1, id);
			gen.model.mixinReference.Author instance;
			try (java.sql.ResultSet rs = statement.executeQuery()) {
				if (rs.next()) {
					reader.process(rs.getString(1));
			...
			java.util.List<gen.model.mixinReference.Author> result = new java.util.ArrayList<>(1);
			result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.Optional<gen.model.mixinReference.Author>> find(org.revenj.postgres.BulkReaderQuery query, String uri) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		StringBuilder sb = query.getBuilder();
		int index = query.getArgumentIndex();
		if (uri == null) {
		...
		sb.append("SELECT _r FROM \"mixinReference\".\"Author_entity\" _r WHERE _r.\"ID\" = ?");
		...
		return (rs, ind) -> {
			try {
				...
				rdr.process(res);
				gen.model.mixinReference.Author instance = converter.from(rdr);
				if (!hasCustomSecurity) return java.util.Optional.of(instance);
				java.util.List<gen.model.mixinReference.Author> result = new java.util.ArrayList<>(1);
				result.add(instance);
	...
	@Override
	public java.util.function.BiFunction<java.sql.ResultSet, Integer, java.util.List<gen.model.mixinReference.Author>> find(org.revenj.postgres.BulkReaderQuery query, String[] uris) {
		final org.revenj.postgres.PostgresReader rdr = query.getReader();
		...
		sb.append("SELECT array_agg(_r) FROM \"mixinReference\".\"Author_entity\" _r WHERE _r.\"ID\" = ANY(?)");
		final int[] ids = new int[uris.length];
		for (int i = 0; i < uris.length; i++) {
			try {
				ids[i] = Integer.parseInt(uris[i]);
