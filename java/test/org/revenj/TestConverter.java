...
public class TestConverter {
	...
	public void simpleConversion() throws IOException {
		...
		SimpleConverter converter = new SimpleConverter(null);
	...
	public void compositeConversion() throws IOException {
		...
		locator.container.put(SimpleConverter.class.getName(), new SimpleConverter(locator));
		CompositeConverter converter = new CompositeConverter(locator);
