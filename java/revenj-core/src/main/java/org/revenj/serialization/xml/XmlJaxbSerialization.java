...
public class XmlJaxbSerialization implements Serialization<Element> {
	...
	public XmlJaxbSerialization(JaxbConfiguration[] plugins) {
		...
		register(Short.class, ShortXML.class, ShortXML.convert, s -> s.value);
		register(short.class, ShortXML.class, ShortXML.convert, s -> s.value);
		registerArray(Short.class, ShortXML.ObjectArray.class, ShortXML.ObjectArray.convert, s -> s.value);
		registerList(Short.class, ShortXML.ListXML.class, ShortXML.ListXML.convert, s -> s.value);
		register(short[].class, ShortXML.PrimitiveArray.class, ShortXML.PrimitiveArray.convert, s -> s.value);
