...
public class UserRepository   implements java.io.Closeable, org.revenj.patterns.Repository<gen.model.adt.User>, org.revenj.patterns.PersistableRepository<gen.model.adt.User> {
	...
	public UserRepository(
			 ...
			 final org.revenj.postgres.ObjectConverter<gen.model.adt.User> converter,
	...
	private final org.revenj.postgres.ObjectConverter<gen.model.adt.User> converter;
	...
	public java.util.List<gen.model.adt.User> find(String[] uris) {
		...
		try (java.sql.Statement statement = connection.createStatement();
			org.revenj.postgres.PostgresReader reader = org.revenj.postgres.PostgresReader.create(locator)) {
			java.util.List<gen.model.adt.User> result = new java.util.ArrayList<>(uris.length);
			StringBuilder sb = new StringBuilder("SELECT _r FROM \"adt\".\"User_entity\" _r WHERE _r.\"username\" IN (");
