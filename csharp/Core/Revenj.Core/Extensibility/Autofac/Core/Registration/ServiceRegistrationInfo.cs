...
namespace Revenj.Extensibility.Autofac.Core.Registration
{
	...
	class ServiceRegistrationInfo
	{
		...
		IComponentRegistration[] _implementationsCache;
		...
		/// </summary>
		public IComponentRegistration[] Implementations
		{
			get
			{
				if (_implementationsCache == null)
				{
					_implementationsCache = new IComponentRegistration[_implementations.Count];
					_implementations.CopyTo(_implementationsCache, 0);
				}
				return _implementationsCache;
			}
		}
		...
		bool Any { get { return _implementations.Count > 0; } }
